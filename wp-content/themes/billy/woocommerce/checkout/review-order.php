...
<div class="shop_table woocommerce-checkout-review-order-table">
	<div class="order-top">
			...
			<h3 class="product-total"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></h3>
	</div>
		<?php
		...
		<div class="cart-subtotal cart_item">
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<div class="fee cart_item">
				<h3><?php echo esc_html( $fee->name ); ?></h3>
				<h3><?php wc_cart_totals_fee_html( $fee ); ?></h3>
		</div>
		<?php endforeach; ?>
		...
		<?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) : ?>
			<?php if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) : ?>
				<?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited ?>
					<div class="tax-rate cart_item tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
						<h3><?php echo esc_html( $tax->label ); ?></h3>
						<h3><?php echo wp_kses_post( $tax->formatted_amount ); ?></h3>
				</div>
				<?php endforeach; ?>
			<?php else : ?>
				<div class="tax-total cart_item">
					<h3><?php echo esc_html( WC()->countries->tax_or_vat() ); ?></h3>
					<h3><?php wc_cart_totals_taxes_total_html(); ?></h3>
			</div>
			<?php endif; ?>
		<?php endif; ?>
		...
		<div class="order-total cart_item">
